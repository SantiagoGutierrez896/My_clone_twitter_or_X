...
export default function PerfiLeft() {
  return (
    <>
    <div className="relative md:absolute left-8 h-screen top-10 invisible sm:invisible invisible md:invisible visible lg:visible visible xl:visible visible 2xl:visible">
    ...
    <div className="flex-shrink-0 flex hover:bg-gray-800 rounded-full px-4 py-3 mt-12 mr-2">
            <a href="#" className="flex-shrink-0 group block">
                <div className="flex items-center">
                    <div>
                        <img className="inline-block h-10 w-10 rounded-full" src="https://2f1a7f9478.visitscotland.net/wsimgs/9918359_1094529996.jpg" />
                    </div>
                    <div className="ml-3">
